...
from schemas import ItemSchema, TagAndItemSchema, TagSchema
...
class TagsInStore(MethodView):
    ...
    def get(self, store_id):
        store = StoreModel.query.get_or_404(store_id, description="CANT FIND")
...
class LinksTagsToItem(MethodView):
    ...
    def post(self, item_id, tag_id):
        item: ItemSchema = ItemModel.query.get_or_404(item_id)
